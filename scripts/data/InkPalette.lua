...
local InkPalette = {
    ...
    -- 属性色（v3.0 异兽属性体系）
    flame   = { r = 0.82, g = 0.28, b = 0.15 },   -- 炎
    water   = { r = 0.25, g = 0.50, b = 0.72 },    -- 水
    thunder = { r = 0.85, g = 0.72, b = 0.18 },    -- 雷
    wind    = { r = 0.55, g = 0.75, b = 0.88 },    -- 风
    dark    = { r = 0.12, g = 0.08, b = 0.15 },    -- 暗
    light   = { r = 0.95, g = 0.90, b = 0.70 },    -- 光
    ochre   = { r = 0.62, g = 0.45, b = 0.22 },    -- 土（赭石）
    poison  = { r = 0.30, g = 0.55, b = 0.18 },    -- 毒（腐绿）
    goldMetal = { r = 0.85, g = 0.75, b = 0.35 },  -- 金
    chaos   = { r = 0.70, g = 0.35, b = 0.10 },    -- 混沌（赤丹）
}
